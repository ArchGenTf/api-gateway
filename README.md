...
This repository houses the API Gateway microservice. CI/CD builds, quality gates, and automated GitOps deployments are handled via a centralized reusable pipeline.
